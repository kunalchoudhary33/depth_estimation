...
class Database_Server():
    ...
    def __init__(self):
        self.connection_obj = sqlite3.connect('/home/ubuntu/algotrade/database/mydatabase.db')
    ...
    def insert_ticks(self,ticks):
        ...
        for tick in ticks:
            ...
            date_org = tick['exchange_timestamp']
    ...
    def fetch_ticks(self):
        ...
        if(len(data)>0):
            ...
            data=ticks['last_price'].resample('1min').ohlc().dropna().reset_index()
        return data
